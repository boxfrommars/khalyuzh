...
ограничивается. На графике рациона также показаны сохранённые вместе с каждой
записью исторические границы нормы калорий. Основная линия графика показывает
скользящее среднее за 7 календарных дней по имеющимся записям, а бледная линия
с интерактивными точками сохраняет точные дневные значения.
